###
need to create RESTapi call https://cloud.google.com/compute/docs/reference/latest/projects/enableXpnHost
    POST /compute/v1/projects/tokeshi-net-izen/enableXpnHost HTTP/1.1
...
class ProjectsGet
  ...
  do: ({data}, callback) =>
    ...
    path = "compute/v1/projects/#{data.projectname}/enableXpnHost"
