...
need to create RESTapi call
    DELETE /compute/v1/projects/tokeshi-net-izen/zones/europe-west1-d/instances/instance-1 HTTP/1.1
    Host: www.googleapis.com
    Authorization: Bearer -token-
    Cache-Control: no-cache
    Postman-Token: -token-

format is DELETE https://www.googleapis.com/compute/v1/projects/-name-of-GCP-project-/zones/-name-of-GCP-zone/instances/instance-1/
...
class ProjectsGet
  ...
  do: ({data}, callback) =>
    ...
    path = "compute/v1/projects/#{data.projectname}/zones/#{data.zonename}/instances/#{data.instancename}"
